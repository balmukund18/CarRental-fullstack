...
const Cars = () => {
  ...
  const applyFilter = async ()=>{
    ...
    let filtered = cars;
    if (pickupLocation) {
      filtered = filtered.filter(car => car.location && car.location.toLowerCase() === pickupLocation.toLowerCase());
    }
    if (input !== '') {
  ...
  // Update input if searchQuery changes (e.g., from Navbar search)
  React.useEffect(() => {
