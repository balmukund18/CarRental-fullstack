...
const Banner = () => {
  ...
  // TODO: If changeRole is not in context, lift it up from Navbar and add to context for reuse
  const handleListCar = () => {
    if (isOwner) {
      navigate('/owner');
    } else {
      // TODO: call changeRole from context
      // For now, fallback to navigate('/owner')
      navigate('/owner');
    }
  };
  return (
