        ...
        <div className='flex flex-col md:flex-row items-start md:items-center gap-10 min-md:ml-8'>
            <div className='flex flex-col items-start gap-2'>
                <LocationAutocomplete
                  ...
                  className="h-12 text-base font-medium border-2 border-primary/60 focus:border-primary shadow-md bg-white rounded-full px-6 transition-all duration-200 placeholder-gray-400 focus:ring-2 focus:ring-primary/20"
                />
            </div>
            <div className='flex flex-col items-start gap-2'>
